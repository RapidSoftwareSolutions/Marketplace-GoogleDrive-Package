...
$app->post('/api/GoogleDrive/getFileSingleRevision', function ($request, $response) {
    ...
    $query_str = "https://www.googleapis.com/drive/v3/files/{$data['fileId']}/revisions/{$data['revisionId']}";
