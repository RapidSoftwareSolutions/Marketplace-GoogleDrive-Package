...
$app->post('/api/GoogleDrive/copyFile', function ($request, $response) {
    ...
    $optionalParams = ['ignoreDefaultVisibility'=>'ignoreDefaultVisibility','keepRevisionForever'=>'keepRevisionForever','ocrLanguage'=>'ocrLanguage','supportsTeamDrives'=>'supportsTeamDrives','appProperties'=>'appProperties','contentHintsThumbnailImage'=>'contentHintsThumbnailImage','contentHintsThumbnailMimeType'=>'contentHintsThumbnailMimeType','description'=>'description','mimeType'=>'mimeType','modifiedTime'=>'modifiedTime','name'=>'name','parents'=>'parents','properties'=>'properties','starred'=>'starred','viewedByMeTime'=>'viewedByMeTime','viewersCanCopyContent'=>'viewersCanCopyContent','writersCanShare'=>'writersCanShare','fields'=>'fields'];
    $bodyParams = [
       'query' => ['access_token','ignoreDefaultVisibility','keepRevisionForever','ocrLanguage','supportsTeamDrives','fields'],
       'json' => ['appProperties','contentHintsThumbnailImage','contentHintsThumbnailMimeType','description','mimeType','modifiedTime','name','parents','properties','starred','viewedByMeTime','viewersCanCopyContent','writersCanShare']
    ];
