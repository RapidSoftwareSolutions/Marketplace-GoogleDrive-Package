...
$app->post('/api/GoogleDrive/updateMultipartFile', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','fileId','contentType']);
    ...
    $requiredParams = ['accessToken'=>'access_token','fileId'=>'fileId','contentType'=>'contentType'];
    $optionalParams = ['addParents'=>'addParents','uploadFile'=>'uploadFile','keepRevisionForever'=>'keepRevisionForever','ocrLanguage'=>'ocrLanguage','removeParents'=>'removeParents','supportsTeamDrives'=>'supportsTeamDrives','useContentAsIndexableText'=>'useContentAsIndexableText','appProperties'=>'appProperties','contentHintsIndexableText'=>'contentHintsIndexableText','contentHintsThumbnailImage'=>'contentHintsThumbnailImage','contentHintsMimeType'=>'contentHintsMimeType','description'=>'description','mimeType'=>'mimeType','modifiedTime'=>'modifiedTime','name'=>'name','originalFilename'=>'originalFilename','parents'=>'parents','properties'=>'properties','starred'=>'starred','viewedByMeTime'=>'viewedByMeTime','viewersCanCopyContent'=>'viewersCanCopyContent','writersCanShare'=>'writersCanShare'];
    $bodyParams = [
       'query' => ['access_token','addParents','removeParents','uploadType','ignoreDefaultVisibility','ocrLanguage','supportsTeamDrives','keepRevisionForever','useContentAsIndexableText','fields','uploadFile'],
