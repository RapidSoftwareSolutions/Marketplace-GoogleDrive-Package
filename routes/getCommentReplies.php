...
$app->post('/api/GoogleDrive/getCommentReplies', function ($request, $response) {
    ...
    $query_str = "https://www.googleapis.com/drive/v3/files/{$data['fileId']}/comments/{$data['commentId']}/replies";
