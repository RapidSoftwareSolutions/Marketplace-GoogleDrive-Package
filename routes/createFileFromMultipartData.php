...
$app->post('/api/GoogleDrive/createFileFromMultipartData', function ($request, $response) {
    ...
    $requiredParams = ['accessToken'=>'access_token','uploadFile'=>'uploadFile','contentType'=>'contentType'];
    ...
    $bodyParams = [
       'query' => ['access_token','uploadType','ignoreDefaultVisibility','ocrLanguage','supportsTeamDrives','keepRevisionForever','useContentAsIndexableText','fields','uploadFile'],
